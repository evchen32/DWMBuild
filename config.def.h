...
static const char col_nord1[]       = "#434C5E";
...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_nord4, col_gray1, col_gray2 },
	[SchemeSel]  = { col_nord4, col_nord1,  col_nord4  },
};
...
/* commands */
static const char *dmenucmd[] = { "dmenu_run", "-fn", dmenufont, "-nb", col_gray1, "-nf", col_nord4, "-sb", col_nord1, "-sf", col_nord4, NULL };
